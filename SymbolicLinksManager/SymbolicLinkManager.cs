...
namespace SymbolicLinksManager
{
    ...
    public static class JunctionPoint
    {
        ...
        /// an existing directory was found</exception>
        public static void Create(string sourceDir, string targetDir, bool ignoreExist = false)
        {
            ...
            if (Directory.Exists(targetDir) && !ignoreExist)
